...
// This file contains the placeholder data for blog posts.
// By centralizing it here, we can easily import it into any component or page,
// including the sitemap generator, without causing build errors.
